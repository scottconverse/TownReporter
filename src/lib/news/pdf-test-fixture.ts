...
/** Two rendered pages for proving a failed page retry never repeats a page
 * that was already transcribed successfully. */
export function twoRenderedPdfFixture(): Uint8Array {
  const streams = ["1 0 0 rg 0 0 72 72 re f\n", "0 0 1 rg 0 0 72 72 re f\n"];
  const bodies = [
    "<< /Type /Catalog /Pages 2 0 R >>",
    "<< /Type /Pages /Kids [3 0 R 4 0 R] /Count 2 >>",
    "<< /Type /Page /Parent 2 0 R /MediaBox [0 0 72 72] /Contents 5 0 R >>",
    "<< /Type /Page /Parent 2 0 R /MediaBox [0 0 72 72] /Contents 6 0 R >>",
