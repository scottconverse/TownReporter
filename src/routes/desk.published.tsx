...
function PublishedPage() {
  ...
  return (
    <DeskShell title="Published" kicker="The record">
      {deskRole.data?.role==="owner"&&<p className="mb-4"><Link to="/desk/legal-removals" className="underline">Legal removal cases</Link> � retained-copy access and external cleanup records.</p>}
      <p className="lede">
