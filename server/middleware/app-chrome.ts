/**
 * Deployed-app (Nitro) half of the app head chrome. Auto-registered as
...
interface AppChromeEvent {
  url: URL;
  req: { method: string; headers: Headers };
}

function requestHost(event: AppChromeEvent): string {
  return (
...
export default async function appChromeMiddleware(
  event: AppChromeEvent,
