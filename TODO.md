...
5. [~] **Legal removal — implementation in progress.** Distinct from normal 30-day trash. Owner policy of 2026-09-06: a sealed, owner-only copy of removed text expires automatically after 12 months; an explicit court order to destroy means keep nothing. Audit and backup handling must respect that exception. Track affected backups and incomplete operator cleanup honestly; ordinary Delete is not this feature.
