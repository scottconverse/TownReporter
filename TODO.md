...
- [x] **Authorized takeover implementation:** documentation reconciliation, Dark Desk/OCR/newsroom corrections and the bounded feature queue below are implemented. Exact source-release checks and publication are recorded separately; production promotion remains with Halo.
