...
**Current release: [0.6.54](docs/releases/0.6.54.md).** Its release record distinguishes implemented behavior from unverified GitHub publication, packaged-install, production-deployment, and live-model results. [0.6.50 release guide](docs/releases/0.6.50.md) · [Changelog](CHANGELOG.md).
