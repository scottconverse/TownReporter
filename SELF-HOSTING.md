...
Repository documentation version: **0.6.71**. See the [0.6.71 release guide](docs/releases/0.6.71.md); it separates source, package metadata, GitHub publication, and production deployment as distinct facts.
