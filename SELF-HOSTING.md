...
Repository documentation version: **0.6.70**. See the [0.6.70 release guide](docs/releases/0.6.70.md); it separates source, package metadata, GitHub publication, and production deployment as distinct facts.
