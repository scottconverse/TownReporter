...
Repository documentation version: **0.6.69**. See the [0.6.69 release guide](docs/releases/0.6.69.md); it separates source, package metadata, GitHub publication, and production deployment as distinct facts.
