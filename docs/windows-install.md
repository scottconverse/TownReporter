...
1. For the beta candidate, open the direct [TownReporter 0.6.35 beta release](https://github.com/scottconverse/TownReporter/releases/tag/v0.6.35) after it is published; for the latest stable build, use the [latest stable releases page](https://github.com/scottconverse/TownReporter/releases/latest). Download the Windows installation ZIP listed under the chosen release's Assets. Extract the ZIP completely into a folder you intend to keep. Do not run it from inside the ZIP.
