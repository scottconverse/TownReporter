...
For TownReporter 0.6.67. The publication uses its configured name, town and visible sections. **Editor’s desk** stays in the public header on desktop and phones; it opens the desk for a signed-in editor and the sign-in flow for everyone else.
