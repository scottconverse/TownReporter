...
**Current release: [0.4.1](https://github.com/scottconverse/TownReporter/releases/tag/v0.4.1).** How to run the desk. You do not need to clone the repo to read this; you do need a running copy and an editor account. Operators who set the box up should start at [setup.md](setup.md).
