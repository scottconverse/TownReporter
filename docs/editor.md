...
**Current release: [0.6.45](https://github.com/scottconverse/TownReporter/releases/tag/v0.6.45).** See the [release guide](releases/0.6.45.md) for changes, installation and deployment evidence. Operators should start at [setup](setup.md). This guide covers a running newsroom with an editor account.
