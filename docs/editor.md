...
**Current release: [0.6.31] — beta.** Direct beta tag: [0.6.31](https://github.com/scottconverse/TownReporter/releases/tag/v0.6.31). Stable release: [0.6.30](https://github.com/scottconverse/TownReporter/releases/tag/v0.6.30). How to run the desk. You do not need to clone the repo to read this; you do need a running copy and an editor account. Operators who set the box up should start at [setup.md](setup.md).
