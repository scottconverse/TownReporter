...
**Current release: [0.6.46](https://github.com/scottconverse/TownReporter/releases/tag/v0.6.46).** See the [release guide](releases/0.6.46.md) for changes, installation and deployment evidence. Editors should start at [the editor guide](editor.md).
