...
**Current release: [0.6.60](releases/0.6.60.md).** See the release guide for changes, operating boundaries, the published GitHub package, and the separate deployment and provider-run evidence. Editors should start at [the editor guide](editor.md).
