...
**Current release: [0.6.31] — beta.** Direct beta tag: [0.6.31](https://github.com/scottconverse/TownReporter/releases/tag/v0.6.31). Stable installation remains [0.6.30](https://github.com/scottconverse/TownReporter/releases/tag/v0.6.30). Editors who only write and publish should start at [editor.md](editor.md). The short clone-and-run is in the [README](../README.md).
