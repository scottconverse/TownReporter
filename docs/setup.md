...
**Current release: [0.6.5](https://github.com/scottconverse/TownReporter/releases/tag/v0.6.5).** Editors who only write and publish should start at [editor.md](editor.md). The short clone-and-run is in the [README](../README.md).
