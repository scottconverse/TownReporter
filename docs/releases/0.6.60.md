...
The tag, GitHub release and packaged Windows asset for this version have not been created yet. They are recorded in this note once they exist. Until then this document is the source-release record only.

**Tag:** `v0.6.60`
**Source commit:** recorded here when the tag is cut from the merged release commit.
**GitHub release:** recorded here when the release is published.
