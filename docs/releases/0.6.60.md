...
This is the documentation record for the 0.6.60 source release. It records the changes and their evidence separately from production deployment and live editorial acceptance. Tag, GitHub release and packaged Windows asset are recorded here after they are published.
