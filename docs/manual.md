...
**Version 0.6.71 · publication and deployment are recorded separately**

[Latest published download](https://github.com/scottconverse/TownReporter/releases/latest) · [0.6.71 release guide and evidence boundaries](releases/0.6.71.md). Source, package metadata, GitHub publication, and running production deployment are separate facts.
