...
VERIFIED: ENG-201 SSRF finding as described (render path check-then-Chromium-reconnect) | C:/Users/scott/Desktop/Code/townreporter-dev/artifacts/audit-townreporter-2026-08-30/01-engineering-deepdive.md:46
VERIFIED: ENG-202 finding (drain interval dev-only; /api/cron/monitors 503 without CRON_SECRET) | C:/Users/scott/Desktop/Code/townreporter-dev/artifacts/audit-townreporter-2026-08-30/01-engineering-deepdive.md:83
VERIFIED: UX-001 finding (uncollapsed navs, ~1300px chrome at 375px) | C:/Users/scott/Desktop/Code/townreporter-dev/artifacts/audit-townreporter-2026-08-30/02-uiux-deepdive.md:68
VERIFIED: ENG-201 fix wired into both Chromium contexts via guardedContext; loopback CONNECT answered 403 and public example.com:443 answered 200 Connection Established in a live run this session | C:/Users/scott/Desktop/Code/townreporter-dev/src/lib/news/render-fetch.ts:99
VERIFIED: ENG-202 fix, rearchitected same-day after CI exposed a Linux build break in its first home: the unattended clock now lives in the app graph with static relative imports, entered only from server/plugins/unattended-clock.ts, no NODE_ENV gate (this deploy never sets NODE_ENV) | C:/Users/scott/Desktop/Code/townreporter-dev/src/lib/news/unattended-scheduler.ts:1
VERIFIED: UX-001 fix live at 375x812 — Sections disclosure aria-expanded=true, all 7 links, nav display flex, driven in the browser this session | C:/Users/scott/Desktop/Code/townreporter-dev/src/components/paper-chrome.tsx:156
VERIFIED: desk-nav fold + Menu toggle (static: typecheck + lint clean; not driven live, no dev-desk credentials at hand) | C:/Users/scott/Desktop/Code/townreporter-dev/src/components/desk-chrome.tsx:235
VERIFIED: promote script order (backup, stop own install only, ff to origin/main, build, start, verify) | C:/Users/scott/Desktop/Code/townreporter-dev/ops/promote.ps1:1
VERIFIED: manual's env table now points at .env.example and the watchdog diagram no longer hard-codes 3000 | C:/Users/scott/Desktop/Code/townreporter-dev/docs/manual.md:725
