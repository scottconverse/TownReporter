...
VERIFIED: ENG-202 fix is a Nitro plugin twin with no NODE_ENV gate (grep across ops/*.ps1 and .env.example found no NODE_ENV; a gate would no-op in production) | C:/Users/scott/Desktop/Code/townreporter-dev/server/plugins/dark-desk-scheduler.ts:20
