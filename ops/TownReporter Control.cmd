...
echo   The Reddit reader starts with them, in the background.
...
:redlib
echo.
echo   Restarting the Reddit reader. This waits for it to answer Reddit,
echo   so it can take a minute. The paper is not affected either way.
"%PS%" -NoProfile -ExecutionPolicy Bypass -File "%OPS%redlib.ps1" restart
goto done
